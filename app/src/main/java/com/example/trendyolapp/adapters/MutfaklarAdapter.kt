...
class MutfaklarAdapter(var mContext: Context,var mutfaklarList:MutableList<Mutfaklar>,var viewmodel: KesfetViewModel):RecyclerView.Adapter<MutfaklarAdapter.MutfaklarViewHolder>() {
